...
def crop_images(configs):
    crop_info_file = configs["output_path"]
    ...
    for img_idx in crop_dict:
        ...
        for m in range(method_cnt):
            ...
            for i in range(len(crop_boxes)):
                ...
                out_path = os.path.join(configs["crop_img_path"], method_names[m], f"img{img_idx:06d}_crop{i:02d}_{method_names[m]}.png")
            ...
            full_path = os.path.join(configs["crop_img_path"], method_names[m], f"img{img_idx:06d}_full_{method_names[m]}.png")               
